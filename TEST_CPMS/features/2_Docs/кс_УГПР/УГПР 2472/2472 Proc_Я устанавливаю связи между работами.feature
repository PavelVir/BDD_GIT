...
Допустим я перехожу к закладке "Взаимосвязи"
Затем Если появилось окно диалога я нажимаю на кнопку "Да"
Тогда я жду открытия окна 'План работ *' в течение 20 секунд
Создаю связь работы
    ...
    И я выбираю значение реквизита "Последующая работа" из формы списка    
    Тогда открылось окно 'WBS и работы проекта: Форма выбора элемента WBS'
    И в таблице "ДеревоWBS" я нажимаю на кнопку 'Развернуть структуру WBS'
    И в таблице "ДеревоWBS" я перехожу к строке:
    |'Код WBS'|
